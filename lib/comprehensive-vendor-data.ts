...
export const vendorDatabase: Record<string, VendorData> = {
  portnox: {
    ...
    description: "Cloud-native Network Access Control solution with AI-powered zero trust security",
    pricing: {
      model: "per_device",
      basePrice: 20,
      tiers: [
        { min: 1, max: 250, price: 20 },
        { min: 251, max: 500, price: 18 },
        { min: 501, max: 1000, price: 17 },
    ...
    integrations: ["Cisco", "Aruba", "Juniper", "Microsoft AD", "Azure AD", "Okta", "SIEM Solutions", "MDM Platforms"],
    supportCost: 0,
    implementationCost: 5000,
    maintenanceCost: 0,
    trainingCost: 0,
    complianceFeatures: ["SOC 2", "HIPAA", "PCI DSS", "GDPR", "ISO 27001", "NIST CSF"],
    securityFeatures: ["Zero Trust", "Behavioral Analytics", "Threat Detection", "Automated Remediation"],
    scalability: "high",
    complexity: "low",
    marketShare: 15,
  ...
  cisco: {
    ...
    category: "nac",
    logo: "/cisco-logo.png",
    description: "Identity Services Engine for comprehensive network access control and policy management",
    pricing: {
      model: "per_device",
      basePrice: 150,
      tiers: [
        { min: 1, max: 500, price: 150 },
        { min: 501, max: 1000, price: 135 },
        { min: 1001, max: 5000, price: 120 },
        { min: 5001, max: 10000, price: 105 },
      ],
    },
    features: [
    ...
    integrations: ["Cisco Infrastructure", "Active Directory", "LDAP", "SIEM", "Threat Intelligence"],
    supportCost: 24000,
    implementationCost: 75000,
    maintenanceCost: 33000,
    trainingCost: 25000,
    complianceFeatures: ["FIPS 140-2", "Common Criteria", "SOC 2", "PCI DSS"],
    securityFeatures: ["TrustSec", "pxGrid", "Threat Intelligence", "Posture Assessment"],
    scalability: "high",
    complexity: "high",
    marketShare: 35,
  ...
  aruba: {
    ...
    category: "nac",
    logo: "/aruba-logo.png",
    description: "Policy management platform for secure network access with strong wireless integration",
    pricing: {
      model: "per_device",
      basePrice: 65,
      tiers: [
        { min: 1, max: 500, price: 65 },
        { min: 501, max: 1000, price: 58 },
        { min: 1001, max: 5000, price: 52 },
        { min: 5001, max: 10000, price: 46 },
      ],
    },
    features: [
      "Policy Management",
      ...
      "Network Visibility",
      "OnGuard Posture",
      "OnConnect Secure Access",
    ],
    integrations: ["Aruba Infrastructure", "Microsoft", "VMware", "SIEM Solutions"],
    supportCost: 18000,
    implementationCost: 55000,
    maintenanceCost: 22000,
    trainingCost: 18000,
    complianceFeatures: ["FIPS", "Common Criteria", "SOC 2", "PCI DSS"],
    securityFeatures: ["Dynamic Segmentation", "Threat Detection", "Policy Enforcement"],
    scalability: "high",
    complexity: "medium",
    marketShare: 25,
  ...
  fortinet: {
    ...
    description: "Network Access Control solution with automated response and IoT security",
    pricing: {
      model: "per_device",
      basePrice: 45,
      tiers: [
        { min: 1, max: 500, price: 45 },
        { min: 501, max: 1000, price: 40 },
        { min: 1001, max: 5000, price: 36 },
        { min: 5001, max: 10000, price: 32 },
      ],
    },
    features: [
      "Device Discovery",
    ...
    integrations: ["FortiGate", "FortiSIEM", "FortiAnalyzer", "Active Directory"],
    supportCost: 15000,
    implementationCost: 45000,
    maintenanceCost: 18000,
    trainingCost: 15000,
    complianceFeatures: ["PCI DSS", "HIPAA", "SOC 2"],
    securityFeatures: ["Automated Remediation", "Threat Intelligence", "Security Fabric Integration"],
    scalability: "high",
    complexity: "medium",
    marketShare: 18,
  ...
  microsoft: {
    ...
    description: "Network Policy Server and Intune for device management and conditional access",
    pricing: {
      model: "per_user",
      basePrice: 22,
      tiers: [
        { min: 1, max: 300, price: 22 },
        { min: 301, max: 2500, price: 20 },
        { min: 2501, max: 10000, price: 18 },
      ],
    },
    features: [
      "Conditional Access",
    ...
    integrations: ["Azure AD", "Office 365", "Windows Server", "SCCM"],
    supportCost: 8000,
    implementationCost: 35000,
    maintenanceCost: 8000,
    trainingCost: 12000,
    complianceFeatures: ["SOC 2", "ISO 27001", "FedRAMP", "HIPAA", "GDPR"],
    securityFeatures: ["Zero Trust", "Conditional Access", "Threat Protection"],
    scalability: "high",
    complexity: "medium",
    marketShare: 30,
  ...
  securew2: {
    ...
    description: "Cloud-based certificate management and secure Wi-Fi onboarding platform",
    pricing: {
      model: "per_user",
      basePrice: 15,
      tiers: [
        { min: 1, max: 500, price: 15 },
        { min: 501, max: 1000, price: 13 },
        { min: 1001, max: 5000, price: 11 },
      ],
    },
    features: [
      "Certificate Management",
    ...
    integrations: ["Active Directory", "Google Workspace", "Azure AD", "RADIUS"],
    supportCost: 0,
    implementationCost: 8000,
    maintenanceCost: 0,
    trainingCost: 3000,
    complianceFeatures: ["FIPS 140-2", "SOC 2", "HIPAA"],
    securityFeatures: ["EAP-TLS", "Certificate Lifecycle Management", "PKI Services"],
    scalability: "high",
    complexity: "low",
    marketShare: 12,
  ...
  foxpass: {
    ...
    description: "Cloud directory and certificate authority service for simplified authentication",
    pricing: {
      model: "per_user",
      basePrice: 12,
      tiers: [
    ...
    integrations: ["AWS", "Google Cloud", "Azure", "Okta", "G Suite"],
    supportCost: 0,
    implementationCost: 5000,
    maintenanceCost: 0,
    trainingCost: 2000,
    complianceFeatures: ["SOC 2", "GDPR"],
    securityFeatures: ["Certificate Management", "SSH Key Management"],
    scalability: "medium",
    complexity: "low",
    marketShare: 8,
    customerSatisfaction: 4.1,
  ...
  pulse: {
    ...
    description: "Secure access solution combining VPN and NAC capabilities for hybrid environments",
    pricing: {
      model: "per_user",
      basePrice: 90,
      tiers: [
        { min: 1, max: 500, price: 90 },
        { min: 501, max: 1000, price: 81 },
        { min: 1001, max: 5000, price: 72 },
      ],
    },
    features: [
      "SSL VPN",
    ...
    integrations: ["Active Directory", "LDAP", "SAML", "Multi-vendor Infrastructure"],
    supportCost: 15000,
  ...
  "no-nac": {
    ...
    description: "Baseline scenario without Network Access Control - represents current state risks",
    pricing: {
      model: "flat_rate",
      basePrice: 0,
    },
...
// Legacy database for backward compatibility - ADDED THIS EXPORT

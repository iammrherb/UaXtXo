console.log("🔍 DEBUG: executive-view-complete.js starting to load");
console.log("🔍 Loading ExecutiveViewComplete file...");
/**
...
class ExecutiveViewComplete {
  ...
  createROIBusinessImpactChart() {
    ...
    const options = {
      ...
      series: [{
        name: "Vendors",
        data: vendors.map(v => ({ x: v.paybackMonths, y: v.roi, z: 20 }))
      }],
      xaxis: { title: { text: "Payback Period (Months)" } },
...
console.log("✅ ExecutiveViewComplete class defined successfully");

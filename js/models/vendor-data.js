...
const VENDORS = {
  ...
  extreme: {
    id: 'extreme',
    name: 'Extreme NAC',
    description: 'Extreme Networks NAC',
    logo: 'img/vendors/extreme-logo.png',
    architecture: 'on-premises',
    basePrice: {
      small: 54,     // Per device - perpetual license
      medium: 49,    // Per device - perpetual license
      large: 44,     // Per device - perpetual license
      enterprise: 39 // Per device - perpetual license
    },
    hardware: {
      small: 58000,   // Base hardware cost
      medium: 115000, // Base hardware cost
      large: 230000,  // Base hardware cost
      enterprise: 390000 // Base hardware cost
    },
    implementation: {
      timeInDays: 60,
      costPercentage: 35  // % of license cost
    ...
    maintenance: {
      percentage: 19, // Yearly maintenance as % of license
      downtime: 8,    // Hours per year
    },
    security: {
      zeroTrustScore: 7.5,    // Out of 10
...
// Export data for use across the application

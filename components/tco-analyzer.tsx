...
import CybersecurityPostureView from "./views/cybersecurity-posture-view"
import ComplianceRiskView from "./views/compliance-risk-view"
import OperationalAnalysisView from "./views/operational-analysis-view"
...
const TABS_CONFIG = [
  ...
  { value: "cybersecurity", label: "Security Posture", icon: <Shield /> },
...
export default function TcoAnalyzerUltimate() {
  ...
  const renderView = () => {
    ...
    switch (activeView) {
      ...
      case "operations":
        return <OperationalAnalysisView results={results || []} config={configuration} />
